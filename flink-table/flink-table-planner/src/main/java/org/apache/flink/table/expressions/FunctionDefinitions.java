...
public class FunctionDefinitions {
	...
	public static final FunctionDefinition FLATTENING = new FunctionDefinition("flattening");
	public static final FunctionDefinition GET_COMPOSITE_FIELD = new FunctionDefinition("getCompositeField");
	...
	public static final FunctionDefinition GREATER_THAN_OR_EQUAL = new FunctionDefinition("greaterThanOrEqual");
	public static final FunctionDefinition LESS_THAN = new FunctionDefinition("lessThan");
	public static final FunctionDefinition LESS_THAN_OR_EQUAL = new FunctionDefinition("lessThanOrEqual");
	...
	//public static final FunctionDefinition LOWER_CASE = new FunctionDefinition("lowerCase");
	...
	//public static final FunctionDefinition UPPER_CASE = new FunctionDefinition("upperCase");
	...
	public static final FunctionDefinition QUARTER = new FunctionDefinition("quarter");
	...
	public static final FunctionDefinition ELEMENT = new FunctionDefinition("element");
	...
	public static final FunctionDefinition START = new FunctionDefinition("start");
	public static final FunctionDefinition END = new FunctionDefinition("end");
