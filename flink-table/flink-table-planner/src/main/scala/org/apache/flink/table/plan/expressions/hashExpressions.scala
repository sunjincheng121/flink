...
case class Md5(child: PlannerExpression) extends UnaryPlannerExpression with InputTypeSpec {
...
case class Sha224(child: PlannerExpression) extends UnaryPlannerExpression with InputTypeSpec {
...
case class Sha384(child: PlannerExpression) extends UnaryPlannerExpression with InputTypeSpec {
