...
/**
  ...
  */
case class CharLength(child: PlannerExpression) extends UnaryPlannerExpression {
...
/**
  ...
  */
case class InitCap(child: PlannerExpression) extends UnaryPlannerExpression {
...
/**
  ...
  */
case class Lower(child: PlannerExpression) extends UnaryPlannerExpression {
  override private[flink] def resultType: TypeInformation[_] = STRING_TYPE_INFO
...
/**
  ...
  */
case class Upper(child: PlannerExpression) extends UnaryPlannerExpression with InputTypeSpec {
...
/**
  ...
  */
case class FromBase64(child: PlannerExpression) extends UnaryPlannerExpression with InputTypeSpec {
...
/**
  ...
  */
case class ToBase64(child: PlannerExpression) extends UnaryPlannerExpression with InputTypeSpec {
...
/**
  ...
  */
case class LTrim(child: PlannerExpression) extends UnaryPlannerExpression with InputTypeSpec {
  override private[flink] def expectedTypes: Seq[TypeInformation[_]] = Seq(STRING_TYPE_INFO)
...
/**
  ...
  */
case class RTrim(child: PlannerExpression) extends UnaryPlannerExpression with InputTypeSpec {
