...
public class FunctionDefinitions {
	...
	// time attribute
	public static final FunctionDefinition PROC_TIME = new FunctionDefinition("proctime");
	public static final FunctionDefinition ROW_TIME = new FunctionDefinition("rowtime");
