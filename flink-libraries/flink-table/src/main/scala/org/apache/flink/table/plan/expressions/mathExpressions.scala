...
case class Abs(child: PlannerExpression) extends PlannerUnaryExpression {
...
case class Ceil(child: PlannerExpression) extends PlannerUnaryExpression {
...
case class Exp(child: PlannerExpression) extends PlannerUnaryExpression with InputTypeSpec {
...
case class Floor(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = LONG_TYPE_INFO
...
case class Log10(child: PlannerExpression) extends PlannerUnaryExpression with InputTypeSpec {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Log2(child: PlannerExpression) extends PlannerUnaryExpression with InputTypeSpec {
  override private[flink] def expectedTypes: Seq[TypeInformation[_]] = DOUBLE_TYPE_INFO :: Nil
...
case class Cosh(child: PlannerExpression) extends PlannerUnaryExpression {
...
case class Ln(child: PlannerExpression) extends PlannerUnaryExpression with InputTypeSpec {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Power(left: PlannerExpression, right: PlannerExpression)
  extends PlannerBinaryExpression with InputTypeSpec {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Sinh(child: PlannerExpression) extends PlannerUnaryExpression {
...
case class Sqrt(child: PlannerExpression) extends PlannerUnaryExpression with InputTypeSpec {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Sin(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Cos(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Tan(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Tanh(child: PlannerExpression) extends PlannerUnaryExpression {
...
case class Cot(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Asin(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Acos(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Atan(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Atan2(y: PlannerExpression, x: PlannerExpression) extends PlannerBinaryExpression {
...
case class Degrees(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Radians(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Sign(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = child.resultType
...
case class Round(left: PlannerExpression, right: PlannerExpression)
  extends PlannerBinaryExpression {
...
case class Pi() extends PlannerLeafExpression {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class E() extends PlannerLeafExpression {
  override private[flink] def resultType: TypeInformation[_] = DOUBLE_TYPE_INFO
...
case class Bin(child: PlannerExpression) extends PlannerUnaryExpression {
...
case class Hex(child: PlannerExpression) extends PlannerUnaryExpression {
  override private[flink] def resultType: TypeInformation[_] = BasicTypeInfo.STRING_TYPE_INFO
...
case class UUID() extends PlannerLeafExpression {
