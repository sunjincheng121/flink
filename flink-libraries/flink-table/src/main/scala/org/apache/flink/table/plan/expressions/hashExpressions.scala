...
case class Md5(child: PlannerExpression) extends PlannerUnaryExpression with InputTypeSpec {
...
case class Sha1(child: PlannerExpression) extends PlannerUnaryExpression with InputTypeSpec {
...
case class Sha224(child: PlannerExpression) extends PlannerUnaryExpression with InputTypeSpec {
...
case class Sha256(child: PlannerExpression) extends PlannerUnaryExpression with InputTypeSpec {
...
case class Sha384(child: PlannerExpression) extends PlannerUnaryExpression with InputTypeSpec {
...
case class Sha512(child: PlannerExpression) extends PlannerUnaryExpression with InputTypeSpec {
