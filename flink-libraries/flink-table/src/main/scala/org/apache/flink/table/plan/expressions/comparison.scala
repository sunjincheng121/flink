...
abstract class BinaryComparison extends PlannerBinaryExpression {
...
case class IsNull(child: PlannerExpression) extends PlannerUnaryExpression {
...
case class IsNotNull(child: PlannerExpression) extends PlannerUnaryExpression {
...
case class IsTrue(child: PlannerExpression) extends PlannerUnaryExpression {
...
case class IsFalse(child: PlannerExpression) extends PlannerUnaryExpression {
...
case class IsNotTrue(child: PlannerExpression) extends PlannerUnaryExpression {
...
case class IsNotFalse(child: PlannerExpression) extends PlannerUnaryExpression {
