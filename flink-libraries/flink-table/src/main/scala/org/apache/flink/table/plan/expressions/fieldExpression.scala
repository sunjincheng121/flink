...
abstract class Attribute extends PlannerLeafExpression with NamedExpression {
...
case class PlannerAlias(child: PlannerExpression, name: String, extraNames: Seq[String] = Seq())
    extends PlannerUnaryExpression with NamedExpression {
...
case class PlannerTableReference(name: String, table: Table)
  extends PlannerLeafExpression with NamedExpression {
...
case class PlannerStreamRecordTimestamp() extends PlannerLeafExpression {
