...
public class FlinkAggCallConverterSet {
    private static Map<Class<? extends Aggregation>, AggregationConverter3> expressionClass2ConverterMap
        = new HashMap<>();

    public static <T extends Aggregation> void registerConverter(
        Class<T> expressionClass, AggregationConverter3<T> converter) {
    ...
    public static RelBuilder.AggCall toAggCall(
        ...
        AggregationConverter3 converter = expressionClass2ConverterMap.get(agg.getClass());
        if (converter != null)  {
            ...
            throw new RuntimeException(agg.getClass().getCanonicalName() + " is not supported. "
                                       ...
                                       AggregationConverter3.class.getSimpleName() + "<" + agg.getClass().getSimpleName() + ">"
